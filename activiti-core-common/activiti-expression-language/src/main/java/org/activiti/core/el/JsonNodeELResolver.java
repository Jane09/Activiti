...
public class JsonNodeELResolver extends ELResolver {
     ...
     * @throws NullPointerException if context is null, or if the key is null and this map does
     ...
     * @throws NullPointerException         if context is null, or if this map does not permit null keys
     ...
     *                                      stored in this map.
     * @throws PropertyNotWritableException if this resolver was constructed in read-only mode, or if the
