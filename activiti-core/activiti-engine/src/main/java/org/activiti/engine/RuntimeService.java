...
public interface RuntimeService {
     ...
     * @throws ActivitiObjectNotFoundException when user does not have permission to start the process instance
     ...
     * @throws ActivitiException                if an exception occurs when dispatching the event or when the {@link ActivitiEventDispatcher} is disabled.
