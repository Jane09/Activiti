...
public interface TaskInfoQuery<T extends TaskInfoQuery<?, ?>, V extends TaskInfo> extends Query<T, V> {
     ...
     *
     * @throws ActivitiIllegalArgumentException When passed name list is empty or <code>null</code> or contains <code>null String</code>.
     */
     ...
     *
     * @throws ActivitiIllegalArgumentException When query is executed and {@link #taskCandidateGroup(String)} or {@link #taskCandidateUser(String)} has been executed on the query instance. When passed group list is empty or
     *                                          <code>null</code>.
     */
     ...
     * @throws ActivitiIllegalArgumentException When passed category list is empty or <code>null</code> or contains <code>null String</code>.
     */
